...
import ProfileItem, { ProfileText } from "../../components/profile-item";

const profileText: ProfileText[] = ["판매내역", "구매내역", "관심목록"];
      ...
      <div className=" px-4 py-4">
        ...
        <div className="mt-12">
          <div className="flex space-x-4 items-center">
            ...
            <div>
              <h4 className="text-sm font-vold text-gray-800">니꼬</h4>
