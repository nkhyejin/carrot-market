...
const LiveDetail: NextPage = () => {
  return (
    <div className="py-10 px-4 space-y-4">
      ...
      <div className="h-[50vh] overflow-y-scroll py-10 pb-16 px-4 space-y-4">
      ...
      <div className="fixed w-full mx-auto max-w-md bottom-2 inser-x-0">
        <div className="relative flex items-center">
          ...
          <div className="absolute inset-y-0 flex py-1.5 pr-1.5 right-0 items-center">
            <button className=" cursor-pointer h-full flex items-center bg-orange-500 rounded-full px-3 text-sm text-white focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
              &rarr;
            </button>
          </div>
        </div>
